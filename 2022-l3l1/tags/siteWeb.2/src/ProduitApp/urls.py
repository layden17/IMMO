...
from . import views
from .views import modifier_produit, produit_detail,supprimer_produit_brut,supprimer_autre_produit, autre_produit_detail,modifier_autre_produit,modifier_categorie,supprimer_categorie
...
urlpatterns = [
   ...
   # path('produit_brut/add/', views.add_produit_brut, name='add_produit_brut'),
    path('produit_brut/modifier/<int:pk>/', modifier_produit.as_view(), name='modifier_produit'),
    path('produit_brut/detail/<int:pk>/', produit_detail.as_view(), name='produit_detail'),
    path('produit_brut/supprimer/<int:pk>/', supprimer_produit_brut.as_view(), name='supprimer_produit_brut'),
    path('historique_prix_achat_quintal/<int:pk>/', views.historique_prix_achat_quintal, name='historique_prix_achat_quintal'),
