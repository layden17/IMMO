...
from . import views
from .views import modifier_produit, produit_detail,supprimer_produit_brut, autre_produit_detail,modifier_autre_produit,supprimer_autre_produit
...
urlpatterns = [
    ...
    path('get_categorie_data/', views.get_categorie_data, name='get_categorie_data'),
