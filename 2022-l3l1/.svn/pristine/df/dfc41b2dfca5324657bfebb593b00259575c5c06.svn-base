...
class Produit(models.Model):
    ...
    description = models.TextField(max_length=100, blank=True) # non obligatoire   ,
...
class ProduitBrut(Produit):
    ...
    type_fer = models.CharField(max_length=100, choices=type_fers, default='Fer /6')

    stock_quintal=models.DecimalField(max_digits=10, decimal_places=2,default=0)
    stock_barre=models.IntegerField(default=0)
    stock_metre= models.DecimalField(max_digits=10, decimal_places=2,default=0)

    prix_quintal = models.DecimalField(max_digits=10, decimal_places=2,default=0)
    prix_metre = models.DecimalField(max_digits=10, decimal_places=2,default=0)
    prix_barre = models.DecimalField(max_digits=10, decimal_places=2,default=0)


    prix_achat_quintal = models.DecimalField(max_digits=10, decimal_places=2,default=0)
    prix_achat_barre = models.DecimalField(max_digits=10, decimal_places=2,default=0)
    prix_achat_metre = models.DecimalField(max_digits=10, decimal_places=2,default=0)
...
"""
modele qui garde l'historique de chaque prix de vente quintal pour les produit brut
"""
class HistoriquePrixVenteQuintal(models.Model):
    produit = models.ForeignKey(ProduitBrut, on_delete=models.CASCADE)
    prix = models.DecimalField(max_digits=10, decimal_places=2)
    date = models.DateTimeField(default=timezone.now)
...
class Cadre(models.Model):
    ...
    longueur = models.DecimalField(max_digits=10, decimal_places=2, default=0) 
