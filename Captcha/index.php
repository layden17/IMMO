...
function NouvelleImage($dir){
        ...
        chdir("$dir/c-$t");
            ...
            for($i = 1 ; $i<=3 ; $i++){
                for($j = 1 ; $j <=3 ; $j++){
                    ...
                    $TailleImage = getimagesize("$dir/$t.png");
                    ...
                    $ImageActuelle = imagecreatefrompng("$dir/$t.png");
    ...
    chdir("https://www.nicolas-denis.net/captcha_L2E2/");
}
...
NouvelleImage("https://nicolas-denis.net/captcha_L2E2/images/");
$r = RandomImage("captcha");
list($q1,$q2,$q3,$q4,$q5) = RandomQuestion("captcha");
$test = "https://www.nicolas-denis.net/captcha_L2E2/help/WhyShowUp_"
?>
...
<head>
    ...
    <link rel="stylesheet" href="https://www.nicolas-denis.net/captcha_L2E2/style.css">
</head>
<body>

    <form action= "" method="post" class="langues">
        <bloc>
            <input id ="langue_francais" type="radio" name="langue" class="leslangues" value="fr"><label for ="langue_francais"><img src="https://nicolas-denis.net/captcha_L2E2/fr.png" alt="image" class="drapeau"></label>
        </bloc>
        
        <bloc>
             <input id ="langue_anglais" type="radio" name="langue" class="leslangues" value="en"><label for ="langue_anglais"><img src="https://nicolas-denis.net/captcha_L2E2/uk.png" alt="image" class="drapeau"></label>
        </bloc>
        
        
        <bloc>
            <input id ="langue_chinois" type="radio" name="langue" class="leslangues" value="ch"><label for ="langue_chinois"><img src="https://nicolas-denis.net/captcha_L2E2/ch.png" alt="image" class="drapeau"></label>
        </bloc>
...
<form action="" method="post" class="myForm">
            <bloc>
                <input type="radio" id="case1" name="unecase" class = "cases" value="1"/><label for ="case1"><img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/1_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        
            <bloc>
                <input type="radio" id="case2" name="unecase" class="cases" value="2"/><label for ="case2"> <img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/2_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        
            <bloc>
                <input type="radio" id="case3" name="unecase" class="cases" value="3" /><label for ="case3"><img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/3_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        <br>
        
            <bloc>
                <input type="radio" id="case4" name="unecase" class="cases" value="4"/><label for ="case4"> <img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/4_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>

        
            <bloc>
                <input type="radio" id="case5" name="unecase" class="cases" value="5"/><label for ="case5"><img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/5_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        
            <bloc>
                <input type="radio" id="case6" name="unecase" class="cases" value="6"/><label for ="case6"> <img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/6_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        <br>
        
            <bloc>
                <input type="radio" id="case7" name="unecase" class="cases" value="7"/><label for ="case7"><img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/7_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        
            <bloc>
                <input type="radio" id="case8" name="unecase" class="cases" value="8"/><label for ="case8"><img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/8_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        
        
            <bloc>
                <input type="radio" id="case9" name="unecase" class="cases" value="9"/><label for ="case9"> <img src=<?php echo "https://nicolas-denis.net/captcha_L2E2/images/c-$r/9_$r.png"; ?> alt="image" class="meme_hauteur"></label>
            </bloc>
        ...
        <p>
		<img src="https://www.nicolas-denis.net/captcha_L2E2/question_mark.png" onmouseout="hiddenPic();" onmousemove="showPic(event,'<?php echo $test; ?>'+'<?php if (empty($lang) ){ echo 'fr' ; }else { echo $lang; } ?>'+'.jpg');">
		<!--Pourquoi exist Captcha?-->
		<a href  onclick=location.reload([bForceGet])><img src="https://www.nicolas-denis.net/captcha_L2E2/refresh.png"></a>
		<!--Refresh-->
...
<div class ="logo">
    <img src="https://www.nicolas-denis.net/captcha_L2E2/LOMS.png">
</div>
...
<?php
    ...
    if( !empty($_POST['question']) AND !empty($_POST['unecase']) AND !empty($_POST['id_image'])) { //AND !empty($_POST['case'])
        ...
        if ($test[0][0] == 1){
            if(!headers_sent()){
                header('Location: https://www.nicolas-denis.net/captcha_L2E2/humain.php');
            }
            else{
            ...
            if(!headers_sent()){
                header('Location: https://www.nicolas-denis.net/captcha_L2E2/robot.php');
            }
            else{
